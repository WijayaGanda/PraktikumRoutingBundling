...
<body>
    <div class="container m-5">
        ...
        <div class="list-group mt-4">
          <a href="<?php echo e(url('/home')); ?>" class="list-group-item list-group-item-action">
            Tugas Clone (bootstrap Web Personal Profile)
          </a> 
        </div>
...
<?php /**PATH C:\xampp\htdocs\RoutingBundling\resources\views/routing.blade.php ENDPATH**/ ?>